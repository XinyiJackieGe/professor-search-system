...
public class Syns2Index {
  ...
  private static final Analyzer ana = new StandardAnalyzer(Version.LUCENE_30);
   
       /**
        * Takes arg of prolog file name and index directory.
        */
   public static void main(String[] args) throws Throwable {
     String prologFilename = "data/wn_s.pl";
     String indexDir = "data/wordnetIndex";
//           if (args.length == 2)
//           {
//105               prologFilename = args[0];
//106               indexDir = args[1];
//107           }
//108           else
//109           {
...
//112           }
    ...
    * @param num2Words
    */
   private static void index(String indexDir, Map<String,List<String>> word2Nums, Map<String,List<String>> num2Words) throws Throwable {
     int row = 0;
     int mod = 1;
